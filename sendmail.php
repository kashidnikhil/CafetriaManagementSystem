...
function sendMail($to, $subj, $body) {
	...
	$mail->Username = "cssonawane32@gmail.com"; //Email id             
	$mail->Password = "eubaniqtpdemlkvb"; //App specific password
	$mail->SMTPSecure = "tls";                       
	//Set TCP port to connect to
	$mail->Port = 587;
	$mail->From = "cssonawane32@gmail.com"; 
	//$mail->FromName = "cssonawane32@gmail.com"; //To address and name 
